...
/**
 * Layer group for managing map-tile and map-feature elements retrieved via
 ...
 * Extends LayerGroup
 */
export var TemplatedFeaturesOrTilesLayerGroup = LayerGroup.extend({
...
export var templatedFeaturesOrTilesLayerGroup = function (template, options) {
  return new TemplatedFeaturesOrTilesLayerGroup(template, options);
};
